...
const markdownDirectory = path.join(process.cwd(), "src/challenges/vyper");
const JSONDirectory = path.join(process.cwd(), "src/app/vyper/");
const outputDirectory = path.join(process.cwd(), "public/data/vyper");

const processVyperMarkdownFiles = async () => {
...
processVyperMarkdownFiles().catch(console.error);
