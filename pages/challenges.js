...
function ChallengesPage() {
    const challenges = [
        {
            name: "Challenge Name",
            summary: "This is a short summary of what this challenge is about. This is a short summary of what this challenge is about",
            category: "Defi",
            level: 1,
        },
        {
                    ...
                    <section className="flex flex-col ml-5 w-[85%] max-md:ml-0 max-md:w-full">
                        <div className="flex flex-col grow max-md:mt-10 max-md:max-w-full">
                            ...
                            <div className="px-5 mt-7 max-md:max-w-full">
                                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                                    {challenges.filter((challenge) => challenge.level === 1).map((challenge, index) => (
                            ...
                            <div className="px-5 mt-6 max-md:max-w-full">
                                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                                    {challenges.filter((challenge) => challenge.level === 2).map((challenge, index) => (
                                        <ChallengeCard key={index} challenge={challenge} />
                                    ))}
                                </div>
                            </div>
            ...
            <div className="flex flex-col grow justify-center text-base leading-6 max-md:mt-6">
                <div className="flex flex-col pb-7 w-full bg-orange-100 rounded-3xl">
                    ...
                    <div className="flex gap-2 mx-6 mt-3 font-medium tracking-normal text-center text-yellow-800 leading-[150%] max-md:mx-2.5">
                        <div className="justify-center px-7 py-1 whitespace-nowrap bg-orange-200 rounded max-md:px-5"> {challenge.category} </div>
                        <div className="justify-center px-4 py-1 bg-orange-200 rounded"> Level {challenge.level} </div>
                    </div>
                </div>
            </div>
        </article>
