...
<ContentCopy code={`pragma solidity ^0.8.24;
...
<div className="text-center ">
    <img src="/images/contents/staticcall.png" alt="staticcall example" width="750" />
...
<div className="text-center">
_Explore this code further here: [staticcall.sol](https://remix.ethereum.org/?#code=&lang=en&optimize=false&runs=200&evmVersion=null&version=soljson-v0.8.26+commit.8a97fa7a.js)_
</div>
