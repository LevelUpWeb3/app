...
name: "🌀Huracan"
index: 1
summary: Lean ZK by deploying a battle tested project.
...
_Supporting Material: [Private Smart Contracts with Solidity and Circom](https://dev.to/filosofiacodigoen/private-smart-contrcts-with-solidity-circom-b67)_
...
<details>
<summary>Circom instalation guid</summary>
...
_Supporting Material: [Solidity in 15 Minutes](https://dev.to/turupawn/como-lanzar-un-dex-paso-a-pasox-2cnm)_
...
We will use three contracts. The first is the verifier contract that we just generated in the `verifier.sol` file, so go ahead and deploy it now.
...
_Supporting Material: [Privacy Interfaces with Solidity and zk-WASM](https://dev.to/filosofiacodigoen/privacy-interfaces-on-soldity-zk-wasm-2nd1)_
...
* `js/snarkjs.min.js`: Download [this file](https://github.com/iden3/snarkjs/releases/tag/v0.7.4), which contains the snark.js library.
...
You are ready to depoist and withdraw funds on Huracan from the web interface.
