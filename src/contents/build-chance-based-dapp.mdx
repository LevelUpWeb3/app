---
name: "How to build a chance-based game or dApp using Anyrand (powered by drand)"
index: 9
summary: Learn how to build a chance-based game using verifiable randomness provided by Anyrand (powered by drand)
author: Anyrand
