...
<div className= "flex">
    <a href="https://x.com/rh_bdl" target="_blank" rel="noopener noreferrer">
        <img
        src="https://pbs.twimg.com/profile_images/1751242830398287872/8VKShh46.jpg"
        alt="RH"
    ...
    <div>
        <p style={{ margin: "0 0 2.5rem 1rem" }}>
            <span style={{ color: "#6A6A6A" }}>Written by {""}</span> <a href="https://x.com/rh_bdl" target="_blank" rel="noopener noreferrer" style={{ color: "black", fontWeight: "bold"}}>RH</a>
            <span style={{ display: "block", color: "#6A6A6A", fontSize: "13px" }}>Jul 20, 2024 · 3 min read</span>
        </p>
    </div>
</div>
