---
name: "Unruggable AI Agents with ZKML"
index: 11
...
A model can, for example, decides who deserves a tip based who has the best comments on Farcaster, buy a token based on market conditions, or [mint an NFT based on your singing skills](https://cryptoidol.tech/). There are endless possibilities in terms of what an AI model can do on-chain.
