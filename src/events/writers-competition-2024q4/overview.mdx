...
4. **Submit your article** by the deadline 9th Oct 2024, 11:59 (UTC). It must be published on a public blog (e.g., Mirror, Hashnode, Hackmd, dev.to, Devpost, Paragraph, Medium, etc.) under an open-source license such as MIT, GPL, or CC BY.
