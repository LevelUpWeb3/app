...
export const LESSON_KEY_MAP = {
  ...
  visibility: "l8",
  functions: "l9",
  "getter-functions": "l10",
  enumerables: "l11",
  struct: "l12",
  "conditional-statements": "l13",
  loops: "l14",
  constructor: "l15",
  "data-location": "l16",
  "try-catch": "l17",
  errors: "l18",
  "validations-and-assertions": "l19",
  "function-modifier": "l20",
  events: "l21",
  "ether-units": "l22",
  payable: "l23",
  fallback: "l24",
  "transacting-ether": "l25",
  "vyper-data-types": "v1",
  "vyper-operator": "v2",
  "vyper-constants": "v3",
  "vyper-immutable": "v4",
  ...
  "vyper-functions": "v11",
  "vyper-structs": "v12",
  "vyper-conditional-statements": "v13",
  "vyper-loops": "v14",
  "vyper-assertions-and-exceptions": "v15",
  "vyper-transacting-ether": "v16",
  "vyper-events": "v17",
  "vyper-reentrancy-locks": "v18",
  "vyper-imports": "v19",
};
