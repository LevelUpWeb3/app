...
export const CODE_SOLUTIONS: CodeTemplatesType = {
  ...
  "inline-assembly": {
    ...
    exercise2:
      "// SPDX-License-Identifier: MIT\npragma solidity ^0.8.26;\n\ncontract InlineAssembly {\n\n\t// Task 1: Create a function named 'divideNumbers' that:\n\t// - Takes two uint256 arguments named 'a' and 'b'\n\t// - Uses inline assembly to divide 'a' and 'b' and returns the result\n\n\tfunction multiplyNumbers(uint256 a, uint256 b) public pure returns (uint256 result) {\n\t\tassembly {\n\t\t\tresult := div(a, b)\n\t\t}\n\t}\n}\n// tip: use the 'div' opcode",
    exercise3:
