...
labels: ["solidity", "ERC20"]  

---

# ERC20 Basics

In this challenge, you will implement a basic ERC20 token contract that includes minting, burning, transferring, and approving functionalities. Follow the instructions provided in the comments to complete the contract.
