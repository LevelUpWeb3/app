...
Operators are special symbols, or keywords that are used to perform operations on variables and values. You can combine objects and operators to create expressions that execute the actual competition
