...
- [Vyper Lang Variable Docs](https://docs.vyperlang.org/en/latest/constants-and-vars.html)
- [Vyper Lang `self` Variable Docs](https://docs.vyperlang.org/en/latest/constants-and-vars.html#the-self-variable)
